...
export class CategoriesController {
   ...
   @ApiResponse({ status: HttpStatus.OK, description: 'Success', type: ReturnedCategoryDto })
   ...
   @ApiResponse({ status: HttpStatus.OK, description: 'Success', type: [GetReturnedCategoryDto] })
   @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Bad Request' })
   findAll() {
