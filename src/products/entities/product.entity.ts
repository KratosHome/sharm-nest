...
export class Product {
    ...
    @OneToMany(() => ProductTranslationEntity, (translation) => translation.product, {cascade: true})
    translations: ProductTranslationEntity[];

    @OneToMany(() => ProductItemsEntity, (translation) => translation.product, {cascade: true})
